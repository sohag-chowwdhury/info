  ...
  <div>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-title class="headline">
        <span class="font-weight-bold">SOHAG</span>
        <span class="blue--text font-weight-bold" >CHOWDHURY</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat to="/resume" active-class="blue--text headline"
          >Resume</v-btn
        >
        <v-btn flat to="/services" active-class="blue--text headline"
          >Services</v-btn
        >
        <v-btn flat to="/portfolio" active-class="blue--text headline"
          >Portfolio</v-btn
        >
     
        <v-btn flat to="/contact" active-class="blue--text headline"
          >Contact</v-btn
        >
